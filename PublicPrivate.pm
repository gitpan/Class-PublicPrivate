...
data can be accessed by retrieving the private hash with the C<private> method.  For example, the following 
code outputs two different values, one for the public value of C<start> and another for the private value of 
C<start>.
...
Returns an instantiation of YourClass, where YourClass is a class that extends Class::PublicPrivate.  Additional
key=>value pairs are stored in the private hash.  Programs that use your class can store any date directly in 
it w/o affecting the object's private data.
...
Copyright (c) 2000 by Miko O'Sullivan.  All rights reserved.  This program is free
software; you can redistribute it and/or modify it under the same terms as
Perl itself.  This software comes with B<NO WARRANTY> of any kind.
